"""DMC stranded cotton colour table.

Maps DMC thread codes to display names and sRGB values. Values are the
widely-published DMC floss RGB approximations; they are a reasonable stand-in
for the real thread but screen colour never matches dyed cotton exactly, so
always confirm against a physical shade card before buying.

Codes are strings, not ints: DMC uses "B5200", "Blanc", "Ecru" and "3861"
alongside plain numbers, so numeric typing would lose entries.
"""

# code -> (name, (r, g, b))
DMC: dict[str, tuple[str, tuple[int, int, int]]] = {
    ...
    "152": ("Shell Pink-MD LT", (226, 160, 153)),
    "153": ("Violet-VY LT", (230, 204, 217)),
    "154": ("Grape-VY DK", (87, 36, 51)),
    "155": ("Blue Violet-MD DK", (152, 145, 182)),
    "156": ("Blue Violet-MD LT", (163, 174, 209)),
    "157": ("Cornflower Blue-VY LT", (187, 195, 217)),
    "158": ("Cornflower Blu-MD V DK", (76, 82, 110)),
    "159": ("Gray Blue-LT", (188, 192, 209)),
    "160": ("Gray Blue-MD", (153, 159, 183)),
    "161": ("Gray Blue", (120, 128, 164)),
    "162": ("Blue-UL VY LT", (219, 236, 245)),
    ...
    "167": ("Yellow Beige-VY DK", (123, 93, 65)),
    ...
    "321": ("Christmas Red", (231, 18, 47)),
    "322": ("Navy Blue-VY LT", (90, 143, 184)),
    "326": ("Rose-VY DK", (179, 59, 75)),
    "327": ("Violet", (99, 54, 102)),
    "333": ("Blue Violet-VY DK", (92, 84, 120)),
    "334": ("Baby Blue-MD", (115, 159, 193)),
    "335": ("Rose", (238, 84, 110)),
    "336": ("Navy Blue", (23, 41, 70)),
    "340": ("Blue Violet-MD", (173, 167, 200)),
    ...
    "407": ("Desert Sand-DK", (194, 142, 120)),
    "413": ("Pewter Gray-DK", (86, 86, 86)),
    "414": ("Steel Gray-DK", (139, 139, 139)),
    "415": ("Pearl Gray", (211, 215, 217)),
    ...
    "517": ("Wedgewood-DK", (16, 127, 135)),
    "518": ("Wedgewood-LT", (79, 147, 167)),
    "519": ("Sky Blue", (126, 177, 200)),
    "520": ("Fern Green-DK", (61, 74, 48)),
    "522": ("Fern Green", (129, 140, 114)),
    "523": ("Fern Green-LT", (154, 164, 138)),
    "524": ("Fern Green-VY LT", (196, 205, 178)),
    ...
    "640": ("Beige Gray-VY DK", (163, 152, 128)),
    "642": ("Beige Gray-DK", (186, 175, 154)),
    ...
    "666": ("Christmas Red-LT", (227, 29, 66)),
    ...
    "798": ("Delft-DK", (70, 106, 142)),
    "799": ("Delft-MD", (116, 142, 182)),
    "800": ("Delft-Pale", (192, 204, 222)),
    "801": ("Coffee Brown-DK", (101, 57, 25)),
    "806": ("Peacock Blue-DK", (61, 149, 165)),
    "807": ("Peacock Blue", (100, 171, 186)),
    "809": ("Delft", (148, 168, 198)),
    ...
    "833": ("Golden Olive-LT", (200, 171, 109)),
    ...
    "844": ("Beaver Brown-UL DK", (72, 72, 72)),
    "869": ("Hazelnut Brown-VY DK", (131, 94, 57)),
    "890": ("Pistachio Grn-UL VY DK", (23, 73, 35)),
    ...
    "924": ("Gray Green-VY DK", (86, 99, 100)),
    "926": ("Gray Green-MD", (152, 174, 174)),
    "927": ("Gray Green-LT", (189, 203, 203)),
    "928": ("Gray Green-VY LT", (219, 227, 227)),
    ...
    "935": ("Avocado Green-DK", (68, 76, 43)),
    "936": ("Avocado Green-VY DK", (76, 84, 40)),
    "937": ("Avocado Green-MD", (98, 113, 51)),
    "938": ("Coffee Brown-UL DK", (54, 31, 14)),
    "939": ("Navy Blue-VY DK", (11, 26, 47)),
    ...
    "972": ("Canary-DP", (255, 181, 21)),
    "973": ("Canary-BRT", (255, 227, 0)),
    "975": ("Golden Brown-DK", (145, 79, 18)),
    "976": ("Golden Brown-MD", (194, 129, 66)),
    ...
    "991": ("Aquamarine-DK", (47, 91, 78)),
    "992": ("Aquamarine-LT", (111, 174, 159)),
    "993": ("Aquamarine-VY LT", (152, 198, 184)),
    "995": ("Electric Blue-DK", (38, 150, 182)),
    "996": ("Electric Blue-MD", (75, 187, 219)),
    ...
    "3041": ("Antique Violet-MD", (149, 111, 124)),
    ...
    "3753": ("Ant. Blue-UL VY LT", (219, 226, 233)),
    "3755": ("Baby Blue", (148, 180, 206)),
    "3756": ("Baby Blue-UL VY LT", (238, 252, 252)),
    "3760": ("Wedgewood-MD", (62, 133, 162)),
    ...
    "3771": ("Tawny-UL VY LT", (244, 187, 169)),
    "3772": ("Desert Sand-VY DK", (160, 108, 80)),
    "3773": ("Desert Sand-MD", (182, 117, 92)),
    "3774": ("Desert Sand-VY LT", (243, 225, 215)),
    "3776": ("Mahogany-LT", (206, 114, 50)),
    ...
    "3815": ("Celadon Green-DK", (68, 118, 90)),
    "3816": ("Celadon Green", (101, 165, 125)),
    "3817": ("Celadon Green-LT", (153, 195, 170)),
    "3818": ("Emerald Grn-UL VY DK", (17, 90, 59)),
    ...
    "3844": ("Turquoise-BRT DK", (18, 174, 186)),
    "3845": ("Turquoise-BRT MD", (4, 196, 202)),
    "3846": ("Turquoise-BRT LT", (6, 227, 230)),
    "3847": ("Teal Green-DK", (52, 125, 117)),
    "3848": ("Teal Green-MD", (85, 147, 146)),
    "3849": ("Teal Green-LT", (82, 179, 164)),
    "3850": ("Green-BRT DK", (55, 132, 119)),
    "3851": ("Green-BRT LT", (73, 179, 161)),
...
def dmc_items() -> list[tuple[str, str, tuple[int, int, int]]]:
    """Return the table as a list of (code, name, rgb) tuples."""
    return [(code, name, rgb) for code, (name, rgb) in DMC.items()]
